            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Add WebSite Elements</h5>
                    ...
                    <div class="alert-success card-body">
                        <form method="POST" action="{{ route('addNaviagtion') }}" id="navigation">
                            ...
                            <div class="row">
                                <x-input-group-element title="Site Logo" placeholder="Site Logo" id="logo" name="logo" type="file" required></x-input-group-element>
                                
                                <x-input-group-element title="WebSite Title" placeholder="WebSite Title" id="web_site_title" name="web_site_title"  required></x-input-group-element>
