    ...
    <div class="main-slide-container">
        <div class="vp-slider-content">
            ...
            <ul class="slider-links text-white text-center">
                ...
                <li><a href="/"><span style="color: var(--vyellow-color);">#DIGITAL MARKETING</span></a></li>
                <li><a href="/"><span style="color: var(--vyellow-color);">#SEO</span></a></li>
                <li><a href="/"><span style="color: var(--vyellow-color);">#Seach Engine Optimization</span></a></li>
                <li><a href="/"><span style="color: var(--vyellow-color);">#Social Media Optimization</span></a></li>
                <li><a href="/"><span style="color: var(--vyellow-color);">#Social Media Marketing</span></a></li>
            </ul>
            <div class="banner-btn"><a href="{{ route('contactUs') }}" class="prime-btn">get started now</a></div>
        </div>
    </div>
</div>
...
<section class="section-one">
    <div class="midd-msg-content">
        <p>"When <b>Innovation</b> will <b>TALK & Design</b> will Visualize, Then Brands <b>Will REACH.</b>"</p>
    </div>
