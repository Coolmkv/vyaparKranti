                        ...
                        <div class="full col-12">
                            ...
                            <div class="newsletter_form" >
                                <form action="javascript:" id="newsletter_form">
                                    @csrf
                                        <input type="email" placeholder="Your Email" name="subscription_email" required />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <button style="padding:.8em" type="button" class="btn btn-primary" onclick="refreshCapthca()">
                                    ...
                                    <input type="text" placeholder="Enter Text in image" name="captcha" id="captchaId" required />
